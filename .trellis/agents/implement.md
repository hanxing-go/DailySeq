...
4. **User handoff** — report changed files and concise manual verification steps unless the user explicitly asks for AI verification
...
4. Provide changed files, key decisions, and concise manual verification steps for the user
5. State whether AI verification/code review was requested; if not, state that it was not run
