...
3. Importance and ordering.
   ...
   - Keyboard shortcuts.
   - Drag reorder.
   - The list order follows completion state, then saved `order`; importance changes can regroup unfinished tasks.
